          ...
          Expanded(
              child: Padding(
                  ...
                  child: Column(children: [
                    ...
                    VerticalGap.s,
                    MainDrawerButton(
                        iconName: 'vendors', title: S.of(context).vendors, routeName: AppRoute.vendors.name),
                    VerticalGap.s,
                    MainDrawerButton(
                        iconName: 'regions', title: S.of(context).regions, routeName: AppRoute.regions.name),
                    VerticalGap.s,
                    MainDrawerButton(
