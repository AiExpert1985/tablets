...
String translateDbTextToScreenText(BuildContext? context, String dbText) {
  ...
  final Map<String, String> lookup = {
    TransactionType.expenditures.name: s.transaction_type_expenditures,
    TransactionType.gifts.name: s.transaction_type_gifts,
    TransactionType.vendorReceipt.name: s.transaction_type_vendor_receipt,
    TransactionType.vendorReturn.name: s.transaction_type_vender_return,
    TransactionType.vendorInvoice.name: s.transaction_type_vender_invoice,
    TransactionType.customerReceipt.name: s.transaction_type_customer_receipt,
    TransactionType.customerReturn.name: s.transaction_type_customer_return,
    TransactionType.customerInvoice.name: s.transaction_type_customer_invoice,
    TransactionType.damagedItems.name: s.transaction_type_damaged_items,
    TransactionType.initialCredit.name: s.transaction_type_initial_credit,
    Currency.dinar.name: s.transaction_payment_Dinar,
    Currency.dollar.name: s.transaction_payment_Dollar,
    PaymentType.credit.name: s.transaction_payment_credit,
    PaymentType.cash.name: s.transaction_payment_cash,
    SellPriceType.retail.name: s.selling_price_type_retail,
    SellPriceType.wholesale.name: s.selling_price_type_whole,
    InvoiceStatus.closed.name: s.invoice_status_closed,
    InvoiceStatus.open.name: s.invoice_status_open,
    InvoiceStatus.due.name: s.invoice_status_due,
    'true': s.yes,
    'false': s.no,
  };
...
String translateScreenTextToDbText(BuildContext? context, String screenText) {
  final s = context != null ? S.of(context) : S.current;
  final Map<String, String> lookup = {
    s.transaction_type_expenditures: TransactionType.expenditures.name,
    s.transaction_type_gifts: TransactionType.gifts.name,
    s.transaction_type_customer_receipt: TransactionType.customerReceipt.name,
    s.transaction_type_vendor_receipt: TransactionType.vendorReceipt.name,
    s.transaction_type_vender_return: TransactionType.vendorReturn.name,
    s.transaction_type_customer_return: TransactionType.customerReturn.name,
    s.transaction_type_vender_invoice: TransactionType.vendorInvoice.name,
    s.transaction_type_customer_invoice: TransactionType.customerInvoice.name,
    s.transaction_type_damaged_items: TransactionType.damagedItems.name,
    s.transaction_type_initial_credit: TransactionType.initialCredit.name,
    s.transaction_payment_Dinar: Currency.dinar.name,
    s.transaction_payment_Dollar: Currency.dollar.name,
    s.transaction_payment_credit: PaymentType.credit.name,
    s.transaction_payment_cash: PaymentType.cash.name,
    s.selling_price_type_retail: SellPriceType.retail.name,
    s.selling_price_type_whole: SellPriceType.wholesale.name,
    s.invoice_status_closed: InvoiceStatus.closed.name,
    s.invoice_status_open: InvoiceStatus.open.name,
    s.invoice_status_due: InvoiceStatus.due.name,
    s.yes: 'true',
    s.no: 'false',
  };
