...
import 'package:tablets/src/features/salesmen/view/salesman_drawer_filters.dart';

class SalesmanDrawer {
...
final salesmanDrawerControllerProvider = Provider<SalesmanDrawer>((ref) {
  return SalesmanDrawer();
});
