              ...
              children: tasks.map((item) {
                final bgColor = !item['isVisited']
                    ...
                    : item['hasTransaction']
                        ...
                        : Colors.amber;
                final fontColor =
                    item['isVisited'] ? Colors.black : Colors.white;
                return Stack(
                  children: [
                    Container(
                      width: 140,
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                color: fontColor, fontWeight: FontWeight.w500),
                          ),
                          const Spacer(),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
...
Future<void> printReport(List<Map<String, dynamic>> salesPointMaps) async {
  try {
    ...
    final Uint8List pdfBytes = await SalesPointPdfGenerator.generatePdf(
        salesPoints); // Use your actual list here
